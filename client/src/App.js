...
function App() {
const alan_key = process.env.ALAN_API_KEY
useEffect(()=>{
  getModels();
...
const [chatLog,setChatLog] = useState([{
  ...
  image_url: "https://wp-media.patheos.com/blogs/sites/27/2014/03/how-can-I-help-you.png",
},{
  user:"me",
...
return (
  <div className={`message-holder ${message.user === 'gpt'} && "chatgpt" `}>
    <div className="chat-message">
      ...
      <img className={`${message.user === 'me' ? 'messageImg-user' : ''}`} width="200" height="200" src={`${message.image_url}`}></img>
    </div>
  </div>
)
}
